    ...
    <>
      <section className="guide">
        <div className="container">
          <h2 className="guide__title wow fadeInDown">How to use BetaNote: quick guide</h2>
          <p className="guide__text wow fadeIn">Welcome to BetaNote! Let's take a look at the user interface.
          Find button "<span>Add new note</span>" and click on it to create your first note</p>
          <img src={UI1} alt="" className="guide__img wow fadeIn"/>
          <p className="guide__text wow fadeIn">There you are. Now you can see workspace. Let's take a look at the menubar. There you can see field (<span>1</span>) where you can type a name of your note.
          ...
          <img src={UI4} alt="" className="guide__img wow fadeIn"/>
          <p className="guide__text wow fadeIn">To cancel searching - click to cross (<span>X</span>) after line "<span>Searching notes with tag [tagname]</span>"</p>
          <p className="guide__text wow fadeIn">Hope you are doing great with this app!
